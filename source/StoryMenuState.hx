...
class StoryMenuState extends MusicBeatState
{
	...
	var weekCharacters:Map<Array<String>, String> = 
	[
		['dad', 'bf', 'gf'] => 'Tutorial', 
		['dad', 'bf', 'gf'] => 'Week1', 
		['spooky', 'bf', 'gf'] => 'Week2'
	...
	override function create()
	{
		...
		var ui_tex = FlxAtlasFrames.fromSparrow(Paths.images('campaign_menu_UI_assets'), Paths.images('campaign_menu_UI_assets', 'xml'));
		...
		for (char in 0...3)
		{
			var weekCharacterThing:MenuCharacter = new MenuCharacter((FlxG.width * 0.25) * (1 + char) - 150, 'bf');
