...
class PlayState extends MusicBeatState
{
	...
	public var noteDelays:Array<Float> = [];
	...
	public var inputArray:Array<Bool> = [false, false, false, false];
	...
	override public function create()
	{
		...
		switch (SONG.song.toLowerCase())
		{
			...
			case 'senpai':
				dialogue = CoolUtil.getList('assets/data/songs/senpai/senpaiDialogue.txt');
			case 'roses':
				dialogue = CoolUtil.getList('assets/data/songs/roses/rosesDialogue.txt');
			case 'thorns':
				dialogue = CoolUtil.getList('assets/data/songs/thorns/thornsDialogue.txt');
		}
		...
		{
			var daStage = new FlxTypedGroup<FlxSprite>();
			defaultCamZoom = 0.9;
			curStage = 'stage';
    ...
    {
        final id:Int = keyToDirection(e.keyCode);
        if (id < 0)
            return;
    ...
    public function keyToDirection(e:Int):Int
	{
        var id:Int = 0;
        switch (e)
        {
	...
	function startCountdown():Void
	{
		...
		startTimer = new FlxTimer().start(Conductor.crochet / 1000, function(tmr:FlxTimer)
		{
			dad.dance();
			gf.dance();
			boyfriend.playAnim('idle', true, false);
	...
	private function popUpScore(strumtime:Float):Void
	{
		...
		trace("Off by: " + Std.int(noteDiff) + "ms");
	...
	function noteMiss(direction:Int = 1):Void
	{
		if (!boyfriend.stunned)
		{
			...
			{
				case 2:
					boyfriend.playAnim('singUPmiss', true, false);
				case 3:
					boyfriend.playAnim('singRIGHTmiss', true, false);
				case 1:
					boyfriend.playAnim('singDOWNmiss', true, false);
				case 0:
					boyfriend.playAnim('singLEFTmiss', true, false);
			}
		}
	}
	...
	function goodNoteHit(note:Note):Void
	{
		if (!note.wasGoodHit)
		{
			...
			{
				case 2:
					boyfriend.playAnim('singUP', true, false);
				case 3:
					boyfriend.playAnim('singRIGHT', true, false);
				case 1:
					boyfriend.playAnim('singDOWN', true, false);
				case 0:
					boyfriend.playAnim('singLEFT', true, false);
			}
	...
	override function beatHit()
	{
		...
		{
			boyfriend.playAnim('hey', true, false);
